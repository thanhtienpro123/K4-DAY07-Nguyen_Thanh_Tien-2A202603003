---
doc_id: amazon-return-policy
title: Amazon Return Policy
source_url: https://digprjsurvey.amazon.com/csad/help/node/GKM69DUUYKQWKWX7
...
Up to 30 days 
Prepaid credit card (depending on the issuer of the card) 
...
Select Amazon Renewed products in "Acceptable," "Good," or "Excellent" condition types.
...
For more information on Amazon Luxury items, or if there are any issues with your Amazon Luxury purchase, please visit our Amazon Luxury Help Page.

Return Fees

While returns are generally free, certain situations or item conditions may incur fees. Note that an item cannot be sent back to you after it has been returned (except certain Amazon Luxury items that incur 100% damage fees). 
...
Late fee 
You may be charged a fee when you do not drop off or complete a carrier pickup on or before the "return by date". 
20% of the item price for the first 30 days after the "return by date"; 100% of the item price afterwards. 

Damage fee 
You may be charged a fee when you return an item that is damaged, missing parts, not in original condition, has tags removed or have obvious signs of use for reasons not due to an Amazon.com or seller error. 
Up to 50% of the item price, except for Amazon Luxury items, which will be charged 100% of the item price. 
